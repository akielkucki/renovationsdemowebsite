    ...
    <footer className="relative bg-surface border-t border-border" ref={ref}>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="flex gap-4">
              {Object.entries(siteConfig.social).map(([platform, url]) => (
                <a
                  ...
                  className="w-10 h-10 bg-background border border-border flex items-center justify-center text-muted hover:text-white hover:border-white/30 transition-all duration-300"
                  aria-label={platform}
                >
                  {platform === "instagram" && (
          ...
          >
            <h4 className="font-[family-name:var(--font-space-grotesk)] text-lg font-semibold text-white mb-6">
              Navigation
            </h4>
            <ul className="space-y-4">
              {siteConfig.navigation.map((item) => (
                <li key={item.label}>
                  <a
                    href={item.href}
                    className="font-[family-name:var(--font-inter)] text-muted hover:text-white transition-colors duration-300"
                  >
                    {item.label}
                  </a>
                </li>
      ...
      <div className="border-t border-border">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            >
              <a href="#" className="font-[family-name:var(--font-inter)] text-sm text-muted hover:text-white transition-colors">
                Privacy Policy
              </a>
              <a href="#" className="font-[family-name:var(--font-inter)] text-sm text-muted hover:text-white transition-colors">
                Terms of Service
